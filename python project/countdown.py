...
from pygame import CONTROLLERBUTTONDOWN 
 
# importing Module
import tiknter as tk 
import datetime
...
class Countdown(tk.Frame):
    ...
    def create_wedgets(self): 
        self.label=tk.Label(self,text="Enter the time in second.")
        self.entry=tk.Entry(self,Justify="sonter") 
    ...
    def reset_button(self): 
        self.seconds_left=0 
        self.stop_timer()    
        self.label["text"]="Enter the timer in second."  
        self.start.forget()
        self.stop.forget() 
        self.reset.forget() 
        self.start.pack() 
    ...
    def stop_timer(self):  
       if self._timer_on: 
            self.after_candel(self._timer_on) 
            self._timer_on = False 
